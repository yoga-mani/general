...
class FixedWidthDataProcess:
    ...
    @classmethod
    def read_and_process_s3_metadata(cls, metadata_file_path):
    ...
    def process_fixed_width_file(self, df, table_name):
        ...
        transformed_data = good_data_df.rdd.map(
            lambda row: FixedWidthDataProcess.convert_fixed_width_row(
                row['value'],
    ...
    def generate_summary_file(self, processed_file_name, order_date,
    ...
    # def main(self, processed_file_location, raw_s3_data_prefix, raw_s3_bucket_name,
    ...
    def main(self, processed_file_location, raw_data_file_location, processed_file_name):
        ...
        df = spark.read.text(f"{raw_data_file_location}")
        ...
        data_df.coalesce(5).write.format("parquet").mode('overwrite').save(processed_file_location)
        logger.info(f"Clean data is written into {processed_file_location}")
        ...
        # self.generate_summary_file(processed_file_name, execution_dag_date,
...
if __name__ == '__main__':
    processed_file_location = "/Users/700007996/Documents/Project/vision_test/PRBEPRX/output/"
    raw_data_file_location = "/Users/700007996/Documents/Project/vision_test/PRBEPRX/PRBEPRX.AU_20240327_171801.TXT"
    raw_meta_file_location = ["/Users/700007996/Documents/Project/vision_test/PRBEPRX/PRBEPRX_20240327_171801.CSV"]
    processed_file_name = "PRBEPRX"
    fixedwidth_ingestion_obj = FixedWidthDataProcess.read_and_process_s3_metadata(raw_meta_file_location)
    fixedwidth_ingestion_obj.main(processed_file_location, raw_data_file_location,
                                  processed_file_name)
    # fixedwidth_ingestion_obj.main(processed_file_location, raw_s3_data_prefix,
    #                               raw_s3_bucket_name,
    #                               processed_file_name,
